...
```java
package com.amazonmarket.amazonmarketsys.modelo;
...
- Crea la clase de la acción en el paquete `com.amazonmarket.amazonmarketsys.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="com.amazonmarket.amazonmarketsys.acciones.MostrarImporte"/>
</controlador>
```

```java
package com.amazonmarket.amazonmarketsys.acciones;
...
- ✅ Coloca las clases de acción en `com.amazonmarket.amazonmarketsys.acciones`
...
- Crea un paquete `cuadrosmando` (ej. `com.amazonmarket.amazonmarketsys.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
